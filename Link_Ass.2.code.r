...
doodler=exp(-2.371+0.007*1940)
log(doodler) 
doodler=exp(-2.371+0.007*1941)
log(doodler) 
...
summary(yo)
sd(yo$y1);sd(yo$y2)
t.test(yo$y1,yo$y2,var.equal = T)
#End!

doodler=exp(3.967-0.005*100)
log(doodler)
doodler=exp(3.967-0.005*105)
log(doodler)

doodler=exp(-5.909-32.337*.005)
log(doodler)
doodler=exp(-5.909-32.337*.01)
log(doodler)
